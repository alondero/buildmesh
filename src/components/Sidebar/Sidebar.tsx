  ...
  return (
    <div className="relative flex h-full" style={{ width }}>
      ...
      <div className="w-full bg-bg-surface border-r border-border-subtle flex flex-col h-full overflow-hidden">
        ...
        <button
          onClick={() => addMesh()}
          className="w-full px-3 py-2.5 flex items-center justify-center gap-1.5 text-[12px] font-sans text-text-muted hover:text-accent-cyan border-t border-dashed border-border-subtle hover:bg-bg-card/40 transition-colors"
        >
