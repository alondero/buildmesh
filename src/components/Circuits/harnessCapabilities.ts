...
// Issue #1369: Kimi now ships per-node attention hooks via `KIMI_CODE_HOME`
// under the worktree (multi-tenant isolation; the user's global
// `~/.kimi/config.toml` is never touched).
