...
|---|---|
| Domain, IPC, and shared contracts | [ADR 0009](0009-shared-rust-ts-types-via-ts-rs.md), [ADR 0010](0010-tauri-ipc-wrapper-over-codegen.md), [ADR 0013](0013-rename-ipc-surface-to-node-mesh.md) |
