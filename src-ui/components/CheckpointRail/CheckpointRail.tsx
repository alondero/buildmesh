import { useWorkspaceStore, type Checkpoint } from '../../stores/workspaceStore';
import { revertCheckpoint } from '../../lib/tauri';
...
export function CheckpointRail({ checkpoints, workspaceId }: CheckpointRailProps) {
