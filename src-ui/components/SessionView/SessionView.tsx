...
export function SessionView() {
  const { activeWorkspace, checkpoints, workspaces, killAgent, spawnAgent } = useWorkspaceStore();
  ...
  return (
    <div className="flex-1 flex flex-col h-full bg-[#0f0f0f]">
      ...
      {/* Checkpoint rail */}
      <CheckpointRail checkpoints={checkpoints} workspaceId={activeWorkspace.id} />
