...
// Re-exported for SessionView (invalidateSummaryCache is called when git changes are detected)
export { invalidateSummaryCache };
function invalidateSummaryCache(_path: string) {
  // No-op: change stats removed from sidebar, kept in SessionView title bar
}
